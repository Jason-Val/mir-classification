...
def go():
    ...
    #fma_pca.init_mel(n_classes, subset=subset, reuse=True, pca_on=True)
...
##############################################################################
    ...
    test_id1 = '{}cnn_c4_pca_on_frequency_real'.format(test_id)
    # 128, 57 if pca, else 128,128
    net = cnn2.build_net([128, 57], n_classes, learning_rate, pca_on=True)
